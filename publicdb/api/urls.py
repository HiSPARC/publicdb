...
urlpatterns = [
    ...
    path('stations/data/<year:year>/<month:month>/', views.stations_with_data, {'type': 'events'}, name="data_stations"),
    ...
    path('stations/weather/<year:year>/', views.stations_with_data, {'type': 'weather'}, name="weather_stations"),
    path('stations/weather/<year:year>/<month:month>/', views.stations_with_data, {'type': 'weather'}, name="weather_stations"),
    path('stations/weather/<date:date>/', views.stations_with_data, {'type': 'weather'}, name="weather_stations"),
    path('stations/singles/', views.stations_with_data, {'type': 'singles'}, name="singles_stations"),
    path('stations/singles/<year:year>/', views.stations_with_data, {'type': 'singles'}, name="singles_stations"),
    path('stations/singles/<year:year>/<month:month>/', views.stations_with_data, {'type': 'singles'}, name="singles_stations"),
    path('stations/singles/<date:date>/', views.stations_with_data, {'type': 'singles'}, name="singles_stations"),
    ...
    path('station/<int:station_number>/data/<year:year>/<month:month>/', views.has_data, {'type': 'events'}, name="has_data"),
    ...
    path('station/<int:station_number>/weather/<year:year>/', views.has_data, {'type': 'weather'}, name="has_weather"),
    path('station/<int:station_number>/weather/<year:year>/<month:month>/', views.has_data, {'type': 'weather'}, name="has_weather"),
    path('station/<int:station_number>/weather/<date:date>/', views.has_data, {'type': 'weather'}, name="has_weather"),
    path('station/<int:station_number>/singles/', views.has_data, {'type': 'singles'}, name="has_singles"),
    path('station/<int:station_number>/singles/<year:year>/', views.has_data, {'type': 'singles'}, name="has_singles"),
    path('station/<int:station_number>/singles/<year:year>/<month:month>/', views.has_data, {'type': 'singles'}, name="has_singles"),
    path('station/<int:station_number>/singles/<date:date>/', views.has_data, {'type': 'singles'}, name="has_singles"),
    ...
    path('station/<int:station_number>/num_events/<year:year>/<month:month>/', views.num_events, name="num_events"),
