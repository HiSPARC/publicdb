...
urlpatterns = [
    ...
    url(r'^stations/data/(?P<year>\d{4})/(?P<month>\d+)/$', views.stations_with_data, {'type': 'events'}, name="data_stations"),
    url(r'^stations/data/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.stations_with_data, {'type': 'events'}, name="data_stations"),
    ...
    url(r'^stations/weather/(?P<year>\d{4})/(?P<month>\d+)/$', views.stations_with_data, {'type': 'weather'}, name="weather_stations"),
    url(r'^stations/weather/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.stations_with_data, {'type': 'weather'}, name="weather_stations"),

    url(r'^station/(?P<station_number>\d+)/$', views.station, name="station"),
    url(r'^station/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.station, name="station"),
    ...
    url(r'^station/(?P<station_number>\d+)/data/(?P<year>\d{4})/(?P<month>\d+)/$', views.has_data, {'type': 'events'}, name="has_data"),
    url(r'^station/(?P<station_number>\d+)/data/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.has_data, {'type': 'events'}, name="has_data"),
    ...
    url(r'^station/(?P<station_number>\d+)/weather/(?P<year>\d{4})/(?P<month>\d+)/$', views.has_data, {'type': 'weather'}, name="has_weather"),
    url(r'^station/(?P<station_number>\d+)/weather/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.has_data, {'type': 'weather'}, name="has_weather"),
    url(r'^station/(?P<station_number>\d+)/config/$', views.config, name="config"),
    url(r'^station/(?P<station_number>\d+)/config/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.config, name="config"),
    ...
    url(r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/$', views.num_events, name="num_events"),
    url(r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.num_events, name="num_events"),
    url(r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/(?P<hour>\d+)/$', views.num_events, name="num_events"),
    ...
    url(r'^station/(?P<station_number>\d+)/plate/(?P<plate_number>\d+)/pulseheight/fit/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', views.get_pulseheight_fit, name="pulseheight_fit"),
    url(r'^station/(?P<station_number>\d+)/plate/(?P<plate_number>\d+)/pulseheight/drift/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/(?P<number_of_days>\d+)/$', views.get_pulseheight_drift, name="pulseheight_drift"),
