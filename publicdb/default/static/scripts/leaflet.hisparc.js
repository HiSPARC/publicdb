...
function createMap(name) {
    ...
    */
    ...
    var tile_url = 'https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}.png';
    if (L.retina) {
        tile_url = 'https://{s}.basemaps.cartocdn.com/light_all/{z}/{x}/{y}@2x.png';
    }

    L.tileLayer(tile_url, {
        attribution: '<a href="https://data.hisparc.nl/" title="HiSPARC data">HiSPARC</a><br>' +
                     '<a href="https://openstreetmap.org/copyright" title="© OpenStreetMap contributors">OSM</a> | ' +
