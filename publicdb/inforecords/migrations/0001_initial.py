    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cluster', models.ForeignKey(on_delete=models.CASCADE, related_name='stations', to='inforecords.Cluster')),
                ('contact', models.ForeignKey(on_delete=models.CASCADE, related_name='stations_contact', to='inforecords.Contact', null=True)),
                ('contactinformation', models.ForeignKey(on_delete=models.CASCADE, related_name='stations', to='inforecords.ContactInformation')),
                ('ict_contact', models.ForeignKey(on_delete=models.CASCADE, related_name='stations_ict_contact', to='inforecords.Contact', null=True)),
            ],
            options={
                'ordering': ('number',),
            },
        ...
        migrations.AddField(
            model_name='pc',
            name='station',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.Station'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='pc',
            name='type',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.PcType'),
            preserve_default=True,
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.MonitorService'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='enabledservice',
            name='pc',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.Pc'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='electronicsbatch',
            name='type',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.ElectronicsType'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='electronics',
            name='batch',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.ElectronicsBatch'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='electronics',
        ...
        migrations.AddField(
            model_name='electronics',
            name='status',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.ElectronicsStatus'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='electronics',
        ...
        migrations.AddField(
            model_name='contact',
            name='contactinformation',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='contacts', to='inforecords.ContactInformation'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='contact',
            name='profession',
            field=models.ForeignKey(on_delete=models.CASCADE, to='inforecords.Profession'),
            preserve_default=True,
        ),
        migrations.AlterUniqueTogether(
            name='contact',
        ...
        migrations.AddField(
            model_name='cluster',
            name='country',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='clusters', to='inforecords.Country'),
            preserve_default=True,
        ),
        migrations.AddField(
            model_name='cluster',
            name='parent',
            field=models.ForeignKey(on_delete=models.CASCADE, related_name='subclusters', blank=True, to='inforecords.Cluster', null=True),
            preserve_default=True,
        ),
    ]
