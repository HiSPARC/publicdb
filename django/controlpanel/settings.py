...
DATABASE_HOST = 'pique'             # Set to empty string for localhost. Not used with sqlite3.
...
MEDIA_ROOT = '/usr/local/hisparc/controlpanel/opslag/'

# URL that handles the media served from MEDIA_ROOT. Make sure to use a
# trailing slash if there is a path component (optional in other cases).
# Examples: "http://media.lawrence.com", "http://example.com/media/"
MEDIA_URL = 'http://tietar.nikhef.nl/opslag/'
...
SECRET_KEY = 'p&v2ju2&6h(7qtl*kj2obkhj(b6bgkhff$s(#u!(*-#5p2jvih'
...
MIDDLEWARE_CLASSES = (
    ...
    'controlpanel.middleware.threadlocals.ThreadLocals',
)
