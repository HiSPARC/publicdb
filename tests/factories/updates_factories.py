...
class UpdateQueueFactory(factory.django.DjangoModelFactory):
...
class AdminUpdateFactory(factory.django.DjangoModelFactory):
...
class UserUpdateFactory(factory.django.DjangoModelFactory):
    # version is based on filename
    version = factory.Faker('random_int', min=0, max=32767)
...
class InstallerUpdateFactory(factory.django.DjangoModelFactory):
    # version is based on filename
    version = factory.Faker('random_int', min=0, max=32767)
