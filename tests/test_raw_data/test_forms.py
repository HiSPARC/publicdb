...
class TestDataDownloadForm(TestCase):
    ...
    def test_clean_valid(self):
        valid_form_data = [
            {
                'data_type': 'events',
                'station_events': self.station.id,
                'start': '2017-1-1',
                'end': '2017-1-2',
            },
            {
                'data_type': 'weather',
                'station_weather': self.station.id,
                'start': '2017-1-1',
                'end': '2017-1-2',
            },
            {
                'data_type': 'singles',
                'station_singles': self.station.id,
                'start': '2017-1-1',
                'end': '2017-1-2',
            },
    ...
    def test_clean_invalid(self):
        invalid_form_data = [
            ...
            (
                'stations',
                'required',
                {'filter_by': 'stations', 'stations': '', 'start': '2017-1-1', 'end': '2017-1-2', 'n': 2},
            ),
            (
                'stations',
                'incorrect_entry',
            ...
            (
                'stations',
                'too_few',
                {'filter_by': 'stations', 'stations': '501', 'start': '2017-1-1', 'end': '2017-1-2', 'n': 2},
            ),
            (
                'stations',
                'too_many',
