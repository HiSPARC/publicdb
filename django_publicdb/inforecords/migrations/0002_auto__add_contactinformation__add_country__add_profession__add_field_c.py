...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('inforecords_cluster', 'new_country', self.gf('django.db.models.fields.related.ForeignKey')(related_name='clusters', to=orm['inforecords.Country']), keep_default=False)

        # Adding field 'Contact.profession'
        db.add_column('inforecords_contact', 'profession', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inforecords.Profession'], blank=True), keep_default=False)
        ...
        db.add_column('inforecords_contact', 'contactinformation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='contacts', to=orm['inforecords.ContactInformation']), keep_default=False)
        ...
        db.add_column('inforecords_station', 'contact_information', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations', to=orm['inforecords.ContactInformation']), keep_default=False)

        # Adding field 'Station.cluster'
        db.add_column('inforecords_station', 'cluster', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations', to=orm['inforecords.Cluster']), keep_default=False)

        # Adding field 'Station.ict_contact'
        db.add_column('inforecords_station', 'ict_contact', self.gf('django.db.models.fields.related.ForeignKey')(related_name='stations_ict_contact', to=orm['inforecords.Contact']), keep_default=False)
