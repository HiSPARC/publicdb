...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_angle')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_long')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_perp')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_angle')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_perp')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_angle')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_long')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_long')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_angle')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_long')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_perp')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_perp')
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_alpha', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_beta', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_radius', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_alpha', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_beta', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_radius', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_alpha', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_beta', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_radius', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_alpha', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_beta', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_radius', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

    def backwards(self, orm):
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_angle', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_long', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_perp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_angle', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_perp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_angle', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_4_long', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_long', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_angle', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_1_long', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_2_perp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.add_column('inforecords_detectorhisparc', 'scintillator_3_perp', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_alpha')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_beta')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_radius')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_1_height')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_alpha')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_beta')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_radius')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_2_height')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_alpha')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_beta')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_radius')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_3_height')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_alpha')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_beta')
        db.delete_column('inforecords_detectorhisparc', 'scintillator_4_radius')
