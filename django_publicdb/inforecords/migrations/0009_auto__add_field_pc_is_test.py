...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pc.is_test'
        db.add_column('inforecords_pc', 'is_test', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pc.is_test'
        db.delete_column('inforecords_pc', 'is_test')
