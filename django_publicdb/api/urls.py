...
urlpatterns = patterns('django_publicdb.api.views',
    ...
    (r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/$', 'num_events_year'),
    (r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/$', 'num_events_month'),
    (r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'num_events_day'),
    (r'^station/(?P<station_number>\d+)/num_events/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/(?P<hour>\d+)/$', 'num_events_hour'),
