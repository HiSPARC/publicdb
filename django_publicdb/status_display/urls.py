...
urlpatterns = patterns('django_publicdb.status_display.views',
    ...
    (r'^source/singleshistlow/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'get_singlesratelow_histogram_source'),
    (r'^source/singleshisthigh/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'get_singlesratehigh_histogram_source'),
    (r'^source/zenith/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'get_zenith_histogram_source'),
    ...
    (r'^source/singlesratelow/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'get_singlesratelow_dataset_source'),
    (r'^source/singlesratehigh/(?P<station_number>\d+)/(?P<year>\d{4})/(?P<month>\d+)/(?P<day>\d+)/$', 'get_singlesratehigh_dataset_source'),
    ...
    (r'^source/station_timing_offsets/(?P<ref_station_number>\d+)/(?P<station_number>\d+)/', 'get_station_timing_offsets_source'),
