...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PulseheightFit.degrees_of_freedom'
        db.add_column(u'histograms_pulseheightfit', 'degrees_of_freedom',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'PulseheightFit.error_type'
        db.add_column(u'histograms_pulseheightfit', 'error_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=64),
                      keep_default=False)

        # Adding field 'PulseheightFit.error_message'
        db.add_column(u'histograms_pulseheightfit', 'error_message',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PulseheightFit.degrees_of_freedom'
        db.delete_column(u'histograms_pulseheightfit', 'degrees_of_freedom')

        # Deleting field 'PulseheightFit.error_type'
        db.delete_column(u'histograms_pulseheightfit', 'error_type')

        # Deleting field 'PulseheightFit.error_message'
        db.delete_column(u'histograms_pulseheightfit', 'error_message')
