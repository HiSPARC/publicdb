...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DetectorTimingOffset'
        db.create_table(u'histograms_detectortimingoffset', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['histograms.Summary'])),
            ('offset_1', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('offset_2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('offset_3', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('offset_4', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'histograms', ['DetectorTimingOffset'])


    def backwards(self, orm):
        # Deleting model 'DetectorTimingOffset'
        db.delete_table(u'histograms_detectortimingoffset')
    ...
    models = {
        u'histograms.configuration': {
            ...
            'mas_reset': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'reduce_data': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'slv_reset': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'startmode': ('django.db.models.fields.BooleanField', [], {}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {}),
            'trig_and_or': ('django.db.models.fields.BooleanField', [], {}),
            ...
            'use_filter': ('django.db.models.fields.BooleanField', [], {}),
            'use_filter_threshold': ('django.db.models.fields.BooleanField', [], {})
        },
        ...
        u'histograms.detectortimingoffset': {
            'Meta': {'object_name': 'DetectorTimingOffset'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'offset_1': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'offset_2': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'offset_3': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'offset_4': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'source': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['histograms.Summary']"})
        },
        ...
        u'histograms.pulseheightfit': {
            'Meta': {'ordering': "('source', 'plate')", 'unique_together': "(('source', 'plate'),)", 'object_name': 'PulseheightFit'},
