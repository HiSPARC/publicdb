...
RECAPTCHA_PUB_KEY       = '6Lfv1NMSAAAAAL1QhTlWB0DMg6Sej53KdN-uZA99'
RECAPTCHA_PRIVATE_KEY   = '6Lfv1NMSAAAAABQVbHyO3EbOwOb7W_q37C0w1kaA'
RECAPTCHA_DISABLE_CHECK = True
...
DATABASES = {
    'default': {
        ...
        'NAME'      : 'publicdb/dev',             # Or path to database file if using sqlite3.
        'TEST_NAME' : 'publicdb/dev/test',
        'USER'      : 'publicdb',                 # Not used with sqlite3.
        'PASSWORD'  : 'rZRXdUxfHxMGGfxn',         # Not used with sqlite3.
...
# DEV_ONLY
MEDIA_ROOT = '/var/www/django_publicdb_media'
...
STATIC_ROOT = '/var/www/django_publicdb/static'
...
TEMPLATE_DIRS = (
    ...
    '/var/www/django_publicdb/templates',
)
